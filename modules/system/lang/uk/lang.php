...
return [
    ...
    'mail' => [
<<<<<<< HEAD
        'failover' => 'Відмовостійке перемикання',
        'failover_mailers' => 'Використовувані транспорти для відмовостійкого перемикання',
        'failover_mailers_placeholer' => 'Виберіть транспорти для використання',
=======
...
<<<<<<< HEAD
        'details' => [
            ...
            'backend' => 'Бекенд',
            'testing' => 'Тестування',
            'exception_context' => 'Контекст винятку',
            'exception_app_env' => 'Середовище винятку',
            'exception_encountered_backend' => 'Виняток виявлено в Бекенді',
            'exception_encountered_unit_test' => 'Виняток виявлено в модульному тесті',
            'oldest_first' => 'Спочатку найстаріші',
            'newest_first' => 'Спочатку найновіші',
            'exception_index' => 'Індекс винятків',
            'exception' => 'Виняток',
            'exception_code' => 'Код винятку',
            'code' => 'Код',
            'stack_trace' => 'Трасування стека <small>(:count frames)</small>',
            'in_app' => 'У додатку',
        ],
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
...
<<<<<<< HEAD
        'manage_other_administrators_comment' => 'Дозволяє користувачеві створювати, оновлювати та видаляти інші облікові записи адміністраторів. Цей дозвіл слід надавати лише довіреним користувачам.',
        'impersonate_users' => 'Видавати себе за користувачів',
        'impersonate_users_comment' => 'Дозволяє користувачеві видавати себе за інших користувачів на їхньому рівні доступу. Цей дозвіл слід надавати лише довіреним користувачам.',
=======
        'impersonate_users' => 'Видавати себе за користувачів',
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
...
<<<<<<< HEAD
        'manage_branding_comment' => 'Цей дозвіл дозволяє користувачеві налаштовувати зовнішній вигляд серверної частини, включаючи користувацький CSS-контент. Це може становити загрозу безпеці, якщо його надати ненадійному користувачеві.'
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
    ],
    'log' => [
