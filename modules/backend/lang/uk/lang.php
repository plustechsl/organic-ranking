...
<<<<<<< HEAD
        'colors_invalid_input' => 'Надане значення кольору недійсне, спробуйте ще раз.',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
    ...
    'account' => [
        ...
        'ok' => 'ОК',
        'sending' => 'Відправка...',
        'password_reset_email' => 'Надіслати email для зміни пароля',
        'manual_password_reset_confirm' => 'Ви впевнені, що бажаєте надіслати цьому користувачеві електронний лист для зміни пароля?',
        'manual_password_reset_success' => 'Користувачеві надіслано електронний лист із інструкціями щодо зміни пароля.',
    ],
    'dashboard' => [
...
<<<<<<< HEAD
        'auto_generate_password' => 'Автоматично генерувати пароль',
        'auto_generate_password_comment' => 'Автоматично створювати безпечний випадковий пароль. Зніміть позначку, щоб встановити пароль вручну.',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
        ...
        'deny' => 'Заборонити',
<<<<<<< HEAD
        'permissions_toggle_section_allow' => 'Надати всі дозволи в цьому розділі',
        'permissions_toggle_section_inherit' => 'Успадкувати всі дозволи в цьому розділі',
        'permissions_toggle_section_deny' => 'Заборонити всі дозволи в цьому розділі',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
...
<<<<<<< HEAD
        ...
        'manage_users_denied' => 'У вас немає дозволу керувати іншими адміністраторами.',
        'throttle_tab' => 'Невдалі входи',
        'throttle_tab_label' => 'Записи невдалих входів',
        'throttle_comment' => 'Переглянути невдалі спроби входу для цього користувача. Ці записи автоматично генеруються, коли спроби входу невдалі. Користувачів блокують після перевищення ліміту спроб.',
        'throttle_ip_address' => 'IP-адреса',
        'throttle_attempts' => 'Спроби',
        'throttle_last_attempt' => 'Остання спроба',
        'throttle_suspended_at' => 'Призупинено о',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
        'group' => [
            'name' => 'Група',
        ...
        'trashed_hint_title' => 'Цей аккаунт було вилучено',
        'trashed_hint_desc' => 'Цей аккаунт було вилучено і він не може бути авторизований. Щоб відновити його, натисніть іконку відновлення користувача в правому нижньому куті.',
    ],
    'list' => [
...
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
        ...
        'create' => 'Створити',
<<<<<<< HEAD
        'create_and_new' => 'Створити та нове',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
...
<<<<<<< HEAD
        'default_prompt' => 'Натисніть кнопку %s, щоб знайти запис',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
    ...
    'relation' => [
<<<<<<< HEAD
        'missing_behavior' => 'Поле ":field" вимагає, щоб контролер ":controller" реалізував поведінку "RelationController".',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
...
<<<<<<< HEAD
        'reorder_title' => 'Перевпорядкувати :name',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
    ...
    'warnings' => [
<<<<<<< HEAD
        'tips' => 'Рекомендації щодо конфігурації Winter CMS',
        'tips_description' => 'Ми виявили деякі проблеми з вашою конфігурацією, які можуть поставити під загрозу безпеку, функціональність або продуктивність вашої інсталяції Winter CMS. Будь ласка, перегляньте проблеми нижче.',
        'how_to_fix' => 'Як виправити',
        'permissions' => 'Каталог :name або його підкаталоги недоступні для запису для PHP. Переконайтеся, що цей каталог та всі підкаталоги доступні для запису у вашому хостинговому середовищі.',
        'extension' => 'Розширення PHP :name не встановлено. Будь ласка, встановіть та активуйте це розширення PHP у вашому хостинговому середовищі.',
        'plugin_missing' => 'Плагін :name є залежністю встановленого плагіна, але недоступний. Будь ласка, встановіть цей плагін.',
        'debug' => 'Режим налагодження ввімкнено. Це не рекомендується для виробничих інсталяцій, оскільки це може розкрити конфіденційну інформацію, призначену лише для розробників.',
        'decompileBackendAssets' => 'Ресурси в бекенді наразі декомпілюються. Це не рекомендується для виробничих інсталяцій, оскільки це може вплинути на продуктивність.',
        'default_backend_user' => 'Знайдено користувача зі стандартними даними для входу (admin / admin@domain.tld). Змініть його ім\'я користувача та/або адресу електронної пошти, щоб захистити систему.',
        'auth_throttle_disabled' => 'Обмеження автентифікації бекенду вимкнено. Це не рекомендується для виробничих інсталяцій, оскільки це може дозволити зловмисним користувачам підібрати паролі користувачів методом грубої сили.',
        'csrf' => 'Захист CSRF вимкнено. Це не рекомендується для виробничих інсталяцій, оскільки це ставить під загрозу безпеку інсталяцій та може дозволити атаки міжсайтового скриптингу.',
        'restrict_base_dir' => 'Обмеження базового каталогу вимкнено. Це не рекомендується для робочих інсталяцій, оскільки це може дозволити темам та файлам конфігурації отримувати доступ до файлів поза вашою інсталяцією Winter CMS.',
=======
        ...
        'default_backend_user' => 'Було виявлено користувача з даними для входу за замовчуванням (admin / admin@domain.tld). Змініть своє ім\'я користувача та/або email-адресу, щоб захистити систему.',
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
    ],
    'editor' => [
...
<<<<<<< HEAD
        'enable_folding' => 'Увімкнути згортання коду',
        'bracket_colors' => 'Увімкнути розфарбовування пар дужок',
        'show_colors' => 'Увімкнути вбудований вибір кольору',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
...
<<<<<<< HEAD
        'show_minimap' => 'Показувати мінімапу',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
        ...
        'allowed_attributes' => 'Дозволені атрибути',
        ...
        'remove_tags' => 'Теги, що видаляються',
        'remove_tags_comment' => 'Теги, що видаляються разом з їх вмістом.',
        ...
        'toolbar_options' => 'Опції панелі інструментів',
        ...
        'toolbar_buttons_preset' => 'Вставити передвстановлений набір кнопок панелі інструментів:',
...
<<<<<<< HEAD
        'toggle_fullscreen' => 'Перемкнути/вимкнути повноекранний режим',
=======
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
    ],
    'tooltips' => [
    ...
    'branding' => [
        ...
        'menu_description' => 'Налаштування зовнішнього виду панелі керування (назва, кольори, логотип).',
        'brand' => 'Бренд',
        'logo' => 'Логотип',
        'logo_description' => 'Завантажте логотип для панелі керування.',
        'favicon' => 'Іконка сайту',
        'favicon_description' => 'Завантажте власну іконку сайту для бекенду',
        'app_name' => 'Назва додатку',
        'app_name_description' => 'Ця назва відображається в заголовку панелі керування.',
        'app_tagline' => 'Девіз додатку',
        'app_tagline_description' => 'Ця назва відображається на екрані входу до панелі керування.',
        'colors' => 'Кольори',
...
>>>>>>> 190bfe4f015fba0e5e4bad42e53137f7de7ac2d8
        ...
        'empty_import_columns_error' => 'Будь ласка, вкажіть кілька стовпців для імпорту.',
        'match_some_column_error' => 'Спочатку зіставте кілька стовпців.',
        'required_match_column_error' => 'Будь ласка, вкажіть збіг для обов\'язкового поля :label.',
