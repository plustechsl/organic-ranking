...
<<<<<<< HEAD
        'default_description' => 'Створено власну тему для :url',
        'scaffold' => [
            'label' => 'Риштування',
            'empty' => 'Пусто',
            'less' => 'Базовий (LESS)',
...
<<<<<<< HEAD
        'manage_pages_comment' => 'Цей дозвіл слід надавати лише довіреним користувачам, оскільки він дозволяє прямий доступ до файлів вмісту сторінки теми, включаючи PHP-код, якщо він увімкнений.',
        'manage_layouts' => 'Керування шаблонами',
        'manage_layouts_comment' => 'Цей дозвіл слід надавати лише довіреним користувачам, оскільки він дозволяє прямий доступ до файлів макета теми, включаючи PHP-код, якщо він увімкнений.',
        'manage_partials' => 'Керування фрагментами',
        'manage_partials_comment' => 'Цей дозвіл слід надавати лише довіреним користувачам, оскільки він дозволяє прямий доступ до часткових файлів теми, включаючи PHP-код, якщо він увімкнений.',
        'manage_themes' => 'Керування темами',
        'manage_themes_comment' => 'Цей дозвіл слід надавати лише довіреним користувачам, оскільки він дозволяє користувачеві додавати нові теми, змінювати існуючу тему або повністю видаляти теми.',
=======
        'manage_layouts' => 'Керування шаблонами',
        'manage_partials' => 'Керування фрагментами',
        'manage_themes' => 'Керування темами',
